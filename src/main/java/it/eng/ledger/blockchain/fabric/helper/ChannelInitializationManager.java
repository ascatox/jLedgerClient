...
import it.eng.ledger.blockchain.fabric.config.OrdererConfig;
import it.eng.ledger.blockchain.fabric.config.Organization;
import it.eng.ledger.blockchain.fabric.config.PeerConfig;
...
public class ChannelInitializationManager {
    ...
    public static ChannelInitializationManager getInstance(HFClient client, ConfigManager configManager, Organization organization) throws JLedgerClientException, InvalidArgumentException {
    ...
    private ChannelInitializationManager(HFClient client, ConfigManager configManager, Organization organization) throws JLedgerClientException, InvalidArgumentException {
        initializeChannel(client, configManager, organization);
    }

    private void setupEnv(HFClient client, ConfigManager configManager, Organization organization) throws InvalidArgumentException, JLedgerClientException {
        this.client = client;
    ...
    private void initializeChannel(HFClient client, ConfigManager configManager, Organization organization) throws JLedgerClientException, InvalidArgumentException {
        ////////////////////////////
